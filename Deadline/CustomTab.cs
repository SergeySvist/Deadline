...
namespace Deadline
{
    ...
    public partial class CustomTabControl : TabControl
    {
        ...
        {
            get => _BorderSize;
            set => _BorderSize = value.LimitToRange(0, 2); //Two is the largest it can be.  Anymore won't be seen.
        }
        ...
        {
            get => _DividerSize;
            set => _DividerSize = value.LimitToRange(0, 2);
        }
                    ...
                    for (int i = 0; i < TabCount; i++)
                    {
                        ...
                        if (BorderEdges && (i == SelectedIndex))
                        {
                            ...
                            if (Alignment == TabAlignment.Top || Alignment == TabAlignment.Bottom)
                            {
                                ...
                                {
                                    misc.Swap(ref ptA, ref ptB); misc.Swap(ref ptC, ref ptD);
                                }
                            }
                            ...
                            if (Alignment == TabAlignment.Right || Alignment == TabAlignment.Left)
                            {
                                ...
                                {
                                    misc.Swap(ref ptA, ref ptC); misc.Swap(ref ptB, ref ptD);
                                }
                            }
                        ...
                        //Indicator
                        {
                            ...
                            e.Graphics.FillRectangle(((misc.TagToInt(TabPages[i]) == 1) ? brushAlternative : ((i == SelectedIndex) ? brushActiveIndicator : brushInActiveIndicator)), rectDivider);
                        }
